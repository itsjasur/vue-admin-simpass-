        ...
        >
          <template #bodyCell="{ column, text, record }">
            ...
            <template v-if="column.dataIndex === 'action'">
              <span @click="openEditOrPopup(record)" class="material-symbols-outlined edit-icon">
                edit
              </span>
            </template>
          </template>
    ...
    <div class="card-part">
      ...
      <div class="card" v-for="(item, index) in dataList" :key="index">
        ...
        <div class="card-row">
          ...
          <span @click="openEditOrPopup(item)" class="right-content"
...
watch(
  ...
  (v) => {
    plansFilterPopup.currentPage = 1
    fetchData()
  }
)
